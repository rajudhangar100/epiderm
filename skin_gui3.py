...
def open_camera():
    ...
    lmain.place(x=0, y=0, relwidth=1, relheight=1)  # Fill entire screen with video
    ...
    # Buttons
    capture_btn = tk.Button(cam_window, text="\U0001F4F8 Capture", font=("Helvetica", 10, "bold"),
                            bg="#007acc", fg="white", command=capture_image)
    home_btn = tk.Button(cam_window, text="\U0001F3E0 Home", font=("Helvetica", 10, "bold"),
                         bg="#28a745", fg="white", command=close_camera)
    exit_btn = tk.Button(cam_window, text="\u274C Exit", font=("Helvetica", 10, "bold"),
                         bg="#dc3545", fg="white", command=close_camera)
    save_btn = tk.Button(cam_window, text="\U0001F4BE Save", font=("Helvetica", 10, "bold"),
                         bg="#28a745", fg="white", command=lambda: save_image(preview_label.image))
    discard_btn = tk.Button(cam_window, text="\U0001F5D1 Discard", font=("Helvetica", 10, "bold"),
                            bg="#dc3545", fg="white", command=hide_preview)
    
    toggle_btn = tk.Checkbutton(
            cam_window,
            text="Toggle Grad-CAM",
    ...
    toggle_btn.place(relx=0.5, rely=0.05, anchor="center", width=120, height=30)


    # Place buttons on top of video stream
